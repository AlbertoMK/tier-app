...
public class ConnectionsTest {
    ...
    public void tryMySQLConnection() throws SQLException {
        ...
        c.connectDatabase();
        User userCreated = new User("Pedrito", "Password", Calendar.getInstance());
        try {
            c.addUser(userCreated);
            User userRetrieved = c.findByUsername("Pedrito").get();
    ...
    public void tryMongoDBConnection() throws SQLException {
        ...
        c.connectDatabase();
        Routine routine = new Routine(5, "Routine name");
        c.addRoutine(routine);
